...
export const MapPinIcon = (p: IconProps) => (
  <svg {...base} {...p}><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 1 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg>
);
...
export const InsuranceIcon = (p: IconProps) => (
  <svg {...base} {...p}><path d="M12 3l8 4v5c0 4.4-3.4 8.5-8 9.5C7.4 20.5 4 16.4 4 12V7l8-4z" /><path d="M9 12l2 2 4-4" /></svg>
);

export const FindCareIcon = (p: IconProps) => (
  <svg {...base} {...p}><circle cx="11" cy="11" r="7" /><path d="M21 21l-4.3-4.3" /><path d="M11 8v6" /><path d="M8 11h6" /></svg>
);
